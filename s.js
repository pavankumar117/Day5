...
//function for printing tables in same page

/*function same(a){
  var tab;
for(var i = 0; i < arr.length; i++) {
for(var j = 0; j <length; j++) {
  tab.document.getElementById('table12');
tab.rows[i+1].cells[j].innerHTML = arr[i][keys[j]];
  console.log('hello');
}
}
}

//End of function for printing objects
*/
